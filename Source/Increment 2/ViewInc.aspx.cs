...
public partial class ViewInc : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        SqlDataAdapter da = new SqlDataAdapter("Select * from inc where uid='" + LabelUid.Text + "'", con);
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        SqlDataAdapter da = new SqlDataAdapter("Select * from inc where uid='" + LabelUid.Text + "' and mon='" + DropDownList1.Text + "' and yr='" + TextBox2.Text + "'", con);
        DataSet ds = new DataSet();
        da.Fill(ds);
